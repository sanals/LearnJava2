...
public final class ImmutableExample {
    ...
    public ImmutableExample(String stringValue, Date dateValue, Map<String, Student> mapValue) {
        ...
        for (Map.Entry<String, Student> entry : mapValue.entrySet()) {
            ...
            tempMap.put(entry.getKey(), new Student(student.getName(), student.getAge(), copySubject(student.getSubject())));
        }
        this.mapValue = Collections.unmodifiableMap(tempMap);;
    }
    ...
    private Subject copySubject(Subject subject) {
        return new Subject(subject.getName(), copyBook(subject.getBook()));
    }
